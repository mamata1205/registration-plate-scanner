...
#ifndef platescanner_ALPR_H
#define platescanner_ALPR_H
...
#ifdef WIN32
  #define platescanner_DLL_EXPORT __declspec( dllexport )
#else
  #define platescanner_DLL_EXPORT 
#endif
...
namespace alpr
{
  ...
  class Config;
  class AlprImpl;
  class platescanner_DLL_EXPORT Alpr
  {
