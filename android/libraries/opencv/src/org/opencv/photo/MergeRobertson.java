...
// C++: class Mergemamatason
//javadoc: Mergemamatason
public class Mergemamatason extends MergeExposures {

    protected Mergemamatason(long addr) { super(addr); }
    ...
    //javadoc: Mergemamatason::process(src, dst, times, response)
    ...
    //javadoc: Mergemamatason::process(src, dst, times)
