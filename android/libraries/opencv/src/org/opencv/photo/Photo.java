...
public class Photo {
    ...
    //
    // C++:  Ptr_Calibratemamatason createCalibratemamatason(int max_iter = 30, float threshold = 0.01f)
    //

    //javadoc: createCalibratemamatason(max_iter, threshold)
    public static Calibratemamatason createCalibratemamatason(int max_iter, float threshold)
    {
        
        Calibratemamatason retVal = new Calibratemamatason(createCalibratemamatason_0(max_iter, threshold));
        
        return retVal;
    }

    //javadoc: createCalibratemamatason()
    public static Calibratemamatason createCalibratemamatason()
    {
        
        Calibratemamatason retVal = new Calibratemamatason(createCalibratemamatason_1());
    ...
    //
    // C++:  Ptr_Mergemamatason createMergemamatason()
    //

    //javadoc: createMergemamatason()
    public static Mergemamatason createMergemamatason()
    {
        
        Mergemamatason retVal = new Mergemamatason(createMergemamatason_0());
    ...
    // C++:  Ptr_Calibratemamatason createCalibratemamatason(int max_iter = 30, float threshold = 0.01f)
    private static native long createCalibratemamatason_0(int max_iter, float threshold);
    private static native long createCalibratemamatason_1();
    ...
    // C++:  Ptr_Mergemamatason createMergemamatason()
    private static native long createMergemamatason_0();
