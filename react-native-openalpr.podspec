...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/mamatasahoo/react-native-platescanner.git', :tag => "v#{s.version}" }
  s.source_files  = 'ios/**/*.{h,m,mm,swift}'

  s.resources = ['ios/Frameworks/platescanner.framework/platescanner.conf', 'ios/Frameworks/platescanner.framework/runtime_data']
  s.frameworks = 'CoreGraphics', 'UIKit'
  s.weak_framework = 'opencv2'
  s.static_framework = true
  s.vendored_frameworks = 'ios/Frameworks/platescanner.framework'
